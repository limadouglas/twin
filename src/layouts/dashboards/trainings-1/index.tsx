...
export default (): React.ReactElement => (
  <Navigator tabBarPosition='bottom' tabBar={(props) => <TrainingsTabBar {...props} />}>
    <Screen name='Easy' component={TrainingsListScreen}/>
    <Screen name='Middle' component={TrainingsListScreen}/>
    <Screen name='Hard' component={TrainingsListScreen}/>
  </Navigator>
);
